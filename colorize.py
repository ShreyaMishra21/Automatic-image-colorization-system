...
# To run it we need to go to the project in the file explorer,there right click and click on open in terminal and then run the below command
# python colorize.py --image images\nature.jpg